    ...
    <footer className="bg-[#1C478A] text-white py-16 px-4">
      <div className="max-w-4xl mx-auto text-center space-y-8">
        ...
        <div className="flex items-center justify-center gap-6">
          <a 
            href="https://www.instagram.com/bimaah2017?igsh=N3pyMmh2Y3J0Mmxx&utm_source=qr" 
            target="_blank" 
            rel="noopener noreferrer"
            className="hover:text-[#97C5D9] transition-colors duration-300"
          ...
          <a 
            href="https://www.tiktok.com/@bimaahinternational?_r=1&_t=ZN-934cAFesF1i" 
            target="_blank" 
            rel="noopener noreferrer"
            className="hover:text-[#97C5D9] transition-colors duration-300"
            aria-label="TikTok"
          ...
          <a 
            href="https://web.facebook.com/bimaahinternational" 
            target="_blank" 
            rel="noopener noreferrer"
            className="hover:text-[#97C5D9] transition-colors duration-300"
            aria-label="Facebook"
